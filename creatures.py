...
creatures = {
    ...
    'MOC': {
        ...
        'ent': [['cool','warm','hot'], ['magical','dangerous'], ['thickets','forested','tangled']],
        'firefly': [['cool','warm','hot'], ['arid','dry','balanced','wet'], ['calm','wild','dangerous']],
        'fishbowl': [],
        'fishy': [['icy','cool','warm','hot']],
        ...
        'kitty': [],
        'kittybed': [],
        'komododragon': [['hot'], ['dangerous'], ['shore','flat','hilly']],
        'litterbox': [],
        'maggot': [['cool','warm','hot'], ['arid','dry','balanced','wet'], ['calm','wild','dangerous']],
        'mediumfish': [['icy','cool','warm','hot']],
        ...
        'petscorpion': [],
        'piranha': [['hot'], ['dangerous'], ['soaked','wet','balanced']],
    ...
    'MC': {
        ...
        'creeper': [['warm','hot'], ['wet','soaked'], ['forested','tangled'], ['dangerous','evil']],
        'enderdragon': [],
        ...
        'pig': [['cool','warm','hot'], ['dry','balanced','wet'], ['calm','wild'], ['brush','thickets']],
        'pigzombie': [['evil'],['molten']],
        'sheep': [['cool','warm'], ['brush','thickets'], ['calm','wild']],
        'silverfish': [['arid'],['hot','warm'],['mountainous','jagged'],['wild','dangerous']],
        'skeleton': [['evil']],
        'slime': [['warm','hot'],['soaked'],['magical','wild','dangerous','evil']],
        'snowman': [['icy'],['evil','magical']],
